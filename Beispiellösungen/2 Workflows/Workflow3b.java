...
enum Antrag {
     ...
     */
    GESTELLT {
        Antrag sachbearbeite(Person p, boolean accept) { return check(p, accept); }
    },
    ...
    GENEHMIGT {
        Antrag sachbearbeite(Person p, boolean accept) { return error(p, GENEHMIGT); }
    },

    ABGELEHNT {
        Antrag sachbearbeite(Person p, boolean accept) { return error(p, ABGELEHNT); }
    };
    ...
    abstract Antrag sachbearbeite(Person p, boolean accept);
    ...
    protected Antrag error(Person p, Antrag status) {
